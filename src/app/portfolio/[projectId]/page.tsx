...
async function getProjectDetails(projectId: string) {
  ...
  const projectsDb = [
    { id: 'project-alpha', title: 'Enterprise CRM Platform', category: 'Web Application', date: '2023-05-15', client: 'Alpha Corp', imageUrl: 'https://blogger.googleusercontent.com/img/a/AVvXsEhvwrQstQum2yQkqbfNrlWG6afChRuoM_QGyJ2tEljDxOTou2O-qkSHK8D651UBMi1Rh3_wm0XODOqENVJ2XqZ6Qy5AxmwY72JBXQpbx1Z9-3JtL7AUjIZNQAUw7T2MKLOl2NGG1_jSUwMCLrRin5ytL2rQE44v37ocV2qM8cihibIaf-djE_CsF_HN5_SF', dataAiHint: 'office collaboration', description: 'A detailed case study of the Enterprise CRM Platform, highlighting challenges, solutions, and outcomes. This project involved a complete overhaul of Alpha Corp\'s sales pipeline, integrating custom analytics and third-party services to boost productivity by 30%.', features: ['Custom Dashboard', 'Automated Reporting', 'Sales Funnel Management', 'API Integrations'], technologies: ['React', 'Node.js', 'PostgreSQL', 'AWS'] },
    { id: 'project-beta', title: 'E-commerce Mobile App', category: 'Mobile App', date: '2023-08-20', client: 'Beta Fashion', imageUrl: 'https://blogger.googleusercontent.com/img/a/AVvXsEghDcCYCH3_5VDVRRv9lCB4EIZ_9bkQuZcx-yfrGchrRSt9C4liEVXijYIm4aZxnlWPWEBWaRYMS_8xUed1OI97IC37kXd4OKIgrdzH8K_Qn1Boq2IHApbtJijADWuhVqgPqfJCrRkCdLG78TwbrA12rJrVKscJaUEZ8aw8wTRDq-uPrnRObEac7YOuTJdA', dataAiHint: 'online shopping app', description: 'Developed a cross-platform mobile application for Beta Fashion, focusing on a seamless user experience and secure payment gateways. The app saw a 50% increase in mobile sales within three months of launch.', features: ['Product Catalog', 'Secure Checkout', 'Push Notifications', 'Order Tracking'], technologies: ['React Native', 'Firebase', 'Stripe SDK'] },
    { id: 'project-gamma', title: 'Cloud Migration for Fintech', category: 'Cloud & DevOps', date: '2024-01-10', client: 'Gamma Solutions', imageUrl: 'https://blogger.googleusercontent.com/img/a/AVvXsEjVzzfUo8-gx_0YFCIn21--kQ8T0rVFmgEj8q_UdQGtBnwUG5sMyd_NepFMT1kav0j6_qm6jO5x3bpWSZPeSbb5W5yOY4p4EYVV5kN6k78v3kiJgZPUy6sCZsPHqmQF-1MoXiVxXXxVEoglqlKdfDJc03VaMGi8rs62xi-gjE0HQledJU4LHAZBkpTjzgV3', dataAiHint: 'cloud security', description: 'Successfully migrated a legacy financial system for a major fintech client to a modern, scalable cloud infrastructure on AWS. This project enhanced security, improved performance, and reduced operational costs by 25%.', features: ['Scalable AWS Architecture', 'CI/CD Automation', 'Enhanced Security Protocols', 'Cost Optimization'], technologies: ['AWS', 'Docker', 'Kubernetes', 'Terraform'] },
  ];
